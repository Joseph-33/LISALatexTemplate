...
% Preamble
\title[]{\bfseries Investigating hyperfine constants of heavy atoms using MCDHF methods}
\subtitle{LISA academic day}
\author[Author]{J. S. Andrews}
...
%    \lisaSplashBlue
    ...
    % Title
    {
    %\setbeamertemplate{A Title}{}
	    \makeatletter % to change template
	    \setbeamertemplate{headline}{

\begin{columns}
	\begin{beamercolorbox}[ht=33px]{background canvas}		
	\end{beamercolorbox}
\end{columns}
    ...
    \setbeamercolor{background canvas}{bg=lisablue}
    \setbeamercolor{inverted normal text}{fg=lisablue, bg=white}
    \setbeamertemplate{background}{
	    \begin{columns}
		    \column{.6\textwidth}
		    \column{.2\textwidth}
		    \vspace{99cm}\includegraphics[height=\paperheight]{images/lisa-bkground2.png}
	    \end{columns}
    }
     \frame{\titlepage}
    }
